...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['kode'])) {
        $produk = new Produk();
        $data = $produk->getProdukByKode($_GET['kode']);
    }
    ?>
    <div class="container">
        ...
        <form action="aksi_produk.php" method="post">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="harga" name="harga" value="<?= $data['harga']; ?>" required>
                </div>
            </div>
            <div class="form-group">
                <label for="expired_date">Expired Date</label>
                <input type="date" id="expired_date" name="expired_date" value="<?= $data['expired_date']; ?>" required>
            </div>
            <div class="form-group">
